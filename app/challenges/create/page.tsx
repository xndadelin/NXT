    ...
    <Container my="xl">
      ...
      >
        ...
        <TextInput
          ...
          onChange={(e) =>
            form.setFieldValue("resource", e.currentTarget.value)
          }
          mt="md"
        />
        <TextInput
        ...
        <Textarea
          ...
          onChange={(e) => {
            form.setFieldValue("hints", e.currentTarget.value);
          }}
          mt="md"
        />
        <Checkbox
          ...
          onChange={(e) =>
            form.setFieldValue("case_insensitive", e.currentTarget.checked)
          }
          mt="md"
        />
