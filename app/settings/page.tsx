...
export default function SettingsPage() {
  ...
  const onChangeEmail = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    notifications.show({
      title: "Success",
      message:
        "Confirmation email sent to your new email address. Please check your inbox (and spam folder).",
      color: "teal",
      icon: <IconCheck size={16} />,
    });
  };
  ...
  const onChangePassword = async () => {
    ...
    notifications.show({
      title: "Success",
      message:
        "Password reset email sent. Pls check your inbox (and spam folder).",
      color: "green",
      icon: <IconCheck size={16} />,
    });
  };
        ...
        <Stack gap="xl">
            ...
            <form onSubmit={onChangeEmail}>
              <Stack gap="md">
                ...
                <Text size="xs" c="dimmed" mt={5}>
                  Changing your email will require confirmation via the new
                  address & the old one.
                </Text>
              </Stack>
            </form>
          ...
          <Card withBorder shadow="sm" radius="md" padding="xl">
            ...
            <Stack gap="md" style={{ display: "flex", flexDirection: "row" }}>
              <Text size="sm">
                You can reset your password by sending a password reset email
