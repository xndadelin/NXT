...
export default function UpdatePasswordPage() {
    ...
    if (!isReady) return (
        <Container size="xs" mt="xl">
            <Paper p="xl" withBorder>
                <Title order={3} mb="md">Password reset</Title>
                <Text>Waiting for password reset confirmation...</Text>
                <Text size="sm" c="dimmed">
                    If nothing happens, your link might be invalid or expired. Please try again!
                </Text>
    ...
    return (
        <Container size='xs' mt="xl">
            <Paper p="xl" withBorder>
                <Title order={3} mb="lg">Reset your password</Title>
                ...
                <form onSubmit={handleUpdatePassword}>
                    ...
                    <Group justify="space-between">
                        <Button variant="subtle" onClick={() => router.push('/settings')} disabled={loading}>
                            Cancel
                        </Button>
